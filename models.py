from flask_sqlalchemy import SQLAlchemy #Handles SQLite database -- Lets you specify SQL items without actually doing SQL queries
...
class User(db.Model):
    ...
    # Stores a hash instead of the actual password itself
...
class Account(db.Model):
    ...
    # In databases you should commit a transaction when done with parties so that you can rollback when there is a problem
